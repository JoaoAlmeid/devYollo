...
export declare const defaultIntegrations: (import("@sentry/types").Integration | Console | Http | OnUncaughtException | OnUnhandledRejection | Modules | ContextLines | Context | LocalVariables | Undici | CoreIntegrations.FunctionToString | CoreIntegrations.LinkedErrors | RequestData)[];
/**
